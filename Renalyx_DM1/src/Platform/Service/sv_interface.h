...
#include "Platform/Service/SV_CAN/SV_CAN.h"
#include "Platform/Service/SV_SYS/SV_SYS.h"
...
typedef struct{
	...
	uint8_t uf_ic_fault;
	uint8_t uf_home;
	uint16_t disinfectant_feedback;
	uint8_t b_hemo_f4;
	uint8_t b_hemo_f3;
	uint8_t b_propo_f2;
	uint16_t ps4status;
	uint16_t DGPstatus;
	uint16_t FPstatus;
	uint16_t PowerFailure;
	uint16_t acid_fd_back;
    uint16_t bicarb_fd_back;
    uint16_t v_c_F_B;
...
typedef enum {
	...
	SV_SENSIN_ID25	= 25,  //Blood pump manual on off
	SV_SENSIN_ID26	= 26,   //blood detector
	SV_SENSIN_ID27	= 27,   //blood_leak_detector
	SV_SENSIN_ID28	= 28,   //ufpump_ic_fault
	SV_SENSIN_ID29	= 29,   //ufpump_home
	SV_SENSIN_ID30	= 30,    //disinfectant_fdbck
	SV_SENSIN_ID31	= 31,        //b_hemo_f4
	SV_SENSIN_ID32	= 32,     //b_hemo_f3
	SV_SENSIN_ID33	= 33,    //B_PROPO_I/F4
	SV_SENSIN_ID34	= 34,  //Calibration
	SV_SENSIN_ID35	= 35,    //BATTERY_LOAD_CURRENT
	SV_SENSIN_ID36	= 36,      //POWER_FAILURE_INDICATION
	SV_SENSIN_ID37	= 37,   //SYSTEM_SHUT_DOWN
	SV_SENSIN_ID_MAX
